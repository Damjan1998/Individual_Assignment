...
#The next part creates a new csv file with the variables listed under 'headers' - file for russian data
...
#The next part creates a csv file for the Yugoslav data        
...
#The next part creates lists for years to use (all in the 90s). Yugoslav population needs to be calculated by
#adding the populations of the countries_yug for. The populations are then put into a new list that contains
